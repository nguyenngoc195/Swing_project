...
public class ListCategory extends JPanel {
    ...
    private String API_URL = "https://1-dot-api-person.appspot.com/_api/v1/categories";
    ...
    CategoryFram categoryFram = null;
    ...
    private void initComponent() {
        ...
        String[] columnNames = {"ID", "Category", "Describe"};
        Object[][] data = {};
    ...
    public void loadData() {
        ...
        try {
            ...
            String responseStr = Jsoup.connect(url)
            ...
            CategoryListResponse responseData = gson.fromJson(responseStr, CategoryListResponse.class);
            ...
            for (Category category : responseData.getData()) {
                ...
                Object[] row = {category.getIDCate(), category.getCategory(), category.getDescribe()};
    ...
    public class AddHandle implements ActionListener {
        ...
        @Override
        public void actionPerformed(ActionEvent e) {
            if (categoryFram == null) {
                categoryFram = new CategoryFram();
            } else {
                categoryFram.frame.setVisible(false);
                categoryFram = new CategoryFram();
            }
        }
    }
